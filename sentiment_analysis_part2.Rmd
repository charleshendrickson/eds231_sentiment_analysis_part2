...
```{r}
#My method for assigning polarity score
...
#This function allows for us to approximate the sentiment (polarity) of text by sentence.

sent <- sentiment(tweets2$text)

sent$polarity <- ifelse(sent$sentiment <0, -1, ifelse(sent$sentiment > 0, 1, 0))
