...
**My sentiment classification method resulted in many more 'negative' and 'neutral' sentiments and much fewer 'neutral' scores being assigned to the tweets data compared to Brandwatch's methods. These results could be due to my method of using the the 'get_sentences()' and 'sentiment()' function to assign a sentiment score (<0, 0, >0) to each sentence and then taking the mean of the sentiment score per tweet. This method makes it much more difficult for a sentence to be neutral becuase all the sentences within a tweet would need to have a sentiment score equal to zero in order for that tweet to have a 'neutral' sentiment." 
